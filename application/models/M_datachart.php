...
class M_datachart extends CI_Model
{
    ...
    public function getEarningsJSON($bidang_penelitian) {
		$sql = "SELECT bidang_penelitian FROM fab_ijin WHERE bidang_penelitian = $bidang_penelitian ORDER BY bidang_penelitian ASC";
		$totals = array(); 
