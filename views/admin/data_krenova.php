        ...
        if(isset($data_krenova)){
            foreach($data_krenova as $row){
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-mini" href="<?php echo site_url('admin/update_administrasi/'.$row->id);?>" type="submit" data-toggle="modal"> 
                            <span class="glyphicon glyphicon-ok" aria-hidden="true"></span>
                        </button>
                    </td>
                    <td>
                        <a class="btn btn-mini" href="<?php echo site_url('admin/hapus_krenova/'.$row->id);?>" onclick="return confirm('Anda yakin?')"> 
