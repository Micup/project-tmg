        ...
        if(isset($data_krenova)){
            foreach($data_krenova as $row){
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-mini" href="<?php echo site_url('admin/update_survey/'.$row->id);?>">
                        <span class="glyphicon glyphicon-ok" aria-hidden="true"></span>
                        </a>
                    </td>
                    <td>
                        <a class="btn btn-mini" href="<?php echo site_url('admin/hapus_survey/'.$row->id);?>" onclick="return confirm('Anda yakin?')"> 
